...
let Srcset = new PurifySourceSet();

describe("Splitting loop", () => {
	const cases: TestCase[] = [
		...
		},
		{
			srcset: "&#xE;&#xE;data:,a&#xE;&#xE;1x&#xE;&#xE;",
			expect: "&#xE;&#xE;data:,a&#xE;&#xE;1x&#xE;&#xE;",
			desc: "shift out U+000E",
		},
		{
			srcset: "&#xF;&#xF;data:,a&#xF;&#xF;1x&#xF;&#xF;",
			expect: "&#xF;&#xF;data:,a&#xF;&#xF;1x&#xF;&#xF;",
			desc: "shift in U+000F",
		},
		{
			srcset: "&#x10;&#x10;data:,a&#x10;&#x10;1x&#x10;&#x10;",
			expect: "&#x10;&#x10;data:,a&#x10;&#x10;1x&#x10;&#x10;",
			desc: "data link escape U+0010",
		},
		...
		{ srcset: "data:,a,,,", expect: "data:,a", desc: "trailing three commas" },
		{
			srcset: "data:,a,, , ",
			expect: "data:,a",
			desc: "trailing two commas space comma space",
		},
...
describe("Descriptor Tokenizer", () => {
	const cases: TestCase[] = [
		...
		{ srcset: "data:,a 1x,", expect: "data:,a", desc: "trailing comma" },
		{
			...
			expect: "data:,c",
			desc: "irregular parens 1",
		},
		{
			srcset: "data:,a ((( , data:,b 1x, ), data:,c",
			expect: "data:,c",
			desc: "irregular parens 2",
		},
		...
		{ srcset: "data:,a /*, data:,b, data:,c */", expect: "data:,b", desc: "block comments" },
		{
			...
			expect: "data:,b",
			desc: "double slash like a comment",
		},
	];
	cases.forEach(({ srcset, expect: assertion, desc }) => {
		test.skip(desc.concat("encodedUrl should match expected value"), () => {
...
describe("Descriptor Parser", () => {
	const cases: TestCase[] = [
		...
		{ srcset: "data:,a 1x 1.0x", expect: "", desc: "1x 1.0x" },
		{
			srcset: "data:,a +1x",
			expect: "",
			desc: "no plus sign allowed on floating point number",
		},
