		...
		<div className="mx-auto max-w-7xl px-2 py-2">
			<article className="mb-8 space-y-8">
				<header className="pt-8">
					<h1 className="text-5xl font-bold tracking-tight">Privacy Policy of Zaptread</h1>
				</header>
				<section className="prose ml-auto dark:prose-invert">
					<p>
						Zaptread operates the <code>https://reubin.app/</code> website, which provides the
						SERVICE.
					</p>
					...
					<p>
						...
						our Service, the Zaptread website.
					</p>
					...
					<p>
						...
						information with anyone except as described in this Privacy Policy. Our Privacy
					...
					<p>
						...
						Conditions, which is accessible at https://reubin.app/, unless otherwise defined in
						this Privacy Policy.
					</p>
					...
					<p>
						...
						name, phone number, and postal address. The information that we collect will be
					...
					<p>
						...
						version, pages of our Service that you visit, the time and date of your visit, the
					...
					<p>
						...
						Service. You have the option to either accept or refuse these cookies, and know
						when a cookie is being sent to your computer. If you choose to refuse our cookies,
					...
					<p>
						...
						delete this from our servers. If you are a parent or guardian and you are aware
						that your child has provided us with personal information, please contact us so
