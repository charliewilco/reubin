		...
		<div className="px-4">
			...
			<div className="prose dark:prose-invert mx-auto">
				...
				<p>
					...
					name, phone number, and postal address. The information that we collect will be used
				...
				<p>
					...
					Service. You have the option to either accept or refuse these cookies, and know when
					a cookie is being sent to your computer. If you choose to refuse our cookies, you may
