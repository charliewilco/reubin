...
export function Dialog({ children, isOpen, onClose, title }: DialogProps) {
	return (
		<_Dialog open={isOpen} onClose={onClose}>
			...
			<_Dialog.Panel className="fixed top-1/2 left-1/2 z-50 max-h-[85vh] w-[90vw] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-sm bg-white p-4 shadow-lg dark:bg-zinc-900">
