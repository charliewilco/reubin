...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Changelogs(variables?: IChangelogsQueryVariables): Promise<IChangelogsQuery> {
      return withWrapper(() => client.request<IChangelogsQuery>(print(ChangelogsDocument), variables));
    }
  };
}
