...
/** A protection rule. */
export type IDeploymentProtectionRule = INode & {
...
export type IDiscussionComment = INode & IComment & IDeletable & IMinimizable & IUpdatable & IUpdatableComment & IReactable & IVotable & {
...
export type IOrganization = INode & IActor & IPackageOwner & IProjectOwner & IRepositoryDiscussionAuthor & IRepositoryDiscussionCommentAuthor & IRepositoryOwner & IUniformResourceLocatable & IMemberStatusable & IProfileOwner & ISponsorable & {
...
export type IUser = INode & IActor & IPackageOwner & IProjectOwner & IRepositoryDiscussionAuthor & IRepositoryDiscussionCommentAuthor & IRepositoryOwner & IUniformResourceLocatable & IProfileOwner & ISponsorable & {
  __typename?: 'User';
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'];
